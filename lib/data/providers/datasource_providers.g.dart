...
String _$authRemoteDataSourceHash() =>
    r'd8bf2544de70e8f1a328f137c069d8724a20b1f6';
...
String _$notificationRemoteDataSourceHash() =>
    r'ae650415ecc72f4d2f0555b1c5b13f247ff4bcab';

@ProviderFor(offersRemoteDataSource)
final offersRemoteDataSourceProvider = OffersRemoteDataSourceProvider._();

final class OffersRemoteDataSourceProvider
    extends
        $FunctionalProvider<
          ...
          OffersRemoteDataSource
        >
    with $Provider<OffersRemoteDataSource> {
  OffersRemoteDataSourceProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
        name: r'offersRemoteDataSourceProvider',
        isAutoDispose: false,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$offersRemoteDataSourceHash();

  @$internal
  @override
  $ProviderElement<OffersRemoteDataSource> $createElement(
    $ProviderPointer pointer,
  ) => $ProviderElement(pointer);

  @override
  OffersRemoteDataSource create(Ref ref) {
    return offersRemoteDataSource(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(OffersRemoteDataSource value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<OffersRemoteDataSource>(value),
    );
  }
}

String _$offersRemoteDataSourceHash() =>
    r'f3cc5db1bce97383b4f1dbe7e5751ebfe15e0471';

@ProviderFor(moderationRemoteDataSource)
final moderationRemoteDataSourceProvider =
    ModerationRemoteDataSourceProvider._();

final class ModerationRemoteDataSourceProvider
    extends
        $FunctionalProvider<
          ...
          ModerationRemoteDataSource
        >
    with $Provider<ModerationRemoteDataSource> {
  ModerationRemoteDataSourceProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
        name: r'moderationRemoteDataSourceProvider',
        isAutoDispose: false,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$moderationRemoteDataSourceHash();

  @$internal
  @override
  $ProviderElement<ModerationRemoteDataSource> $createElement(
    $ProviderPointer pointer,
  ) => $ProviderElement(pointer);

  @override
  ModerationRemoteDataSource create(Ref ref) {
    return moderationRemoteDataSource(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(ModerationRemoteDataSource value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<ModerationRemoteDataSource>(value),
    );
  }
}

String _$moderationRemoteDataSourceHash() =>
    r'3ff934617f729592de1835c07792fa5bb3f7b178';
...
String _$chatRemoteDataSourceHash() =>
    r'324b74dff822417e4b5d42a554a8e8a9b783ba6f';

@ProviderFor(invoicesRemoteDataSource)
final invoicesRemoteDataSourceProvider = InvoicesRemoteDataSourceProvider._();

final class InvoicesRemoteDataSourceProvider
    extends
        $FunctionalProvider<
          ...
          InvoicesRemoteDataSource
        >
    with $Provider<InvoicesRemoteDataSource> {
  InvoicesRemoteDataSourceProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
        name: r'invoicesRemoteDataSourceProvider',
        isAutoDispose: false,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$invoicesRemoteDataSourceHash();

  @$internal
  @override
  $ProviderElement<InvoicesRemoteDataSource> $createElement(
    $ProviderPointer pointer,
  ) => $ProviderElement(pointer);

  @override
  InvoicesRemoteDataSource create(Ref ref) {
    return invoicesRemoteDataSource(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(InvoicesRemoteDataSource value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<InvoicesRemoteDataSource>(value),
    );
  }
}

String _$invoicesRemoteDataSourceHash() =>
    r'4bf5fcc25f35a1e005c87196650d7f5e528b6176';
